...
어떤 패턴의 유용함을 판단하려면 무엇을 고민해봐야 할까? 이것은 [좋은 코드에 대한 고민](https://jbee.io/articles/etc/what-is-good-code/)에서 힌트를 얻을 수 있다. 소프트웨어는 끊임없이 변하기 때문에 **변경에 유연하게 대응하는 코드**를 작성해야 한다. 자연스럽게 변경에 잘 대응하고 변경에 따른 영향 범위를 최소화 할 수 있도록 컴포넌트를 디자인해야 하고 패턴으로부터 이 목적을 달성할 수 있으면 유용하다고 볼 수 있다.
